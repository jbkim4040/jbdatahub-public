...
import asyncio
from routes import pr, security, deploy, request, reports, subscription, errors, portal_login, gemini_usage, photo_reports
...
app.include_router(photo_reports.router, prefix="/api/photo-reports", tags=["PhotoReports"])
